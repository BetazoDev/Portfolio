  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(
        "https://n8n.diabolicalservices.tech/webhook-test/12af5a5a-794c-496f-8ad3-7b66ef4e6c97",
        {
          method: "POST",
          headers: {
  ...
  return (
    <footer id="contact" className="py-24 border-t border-black">
      <div className="grid lg:grid-cols-2 gap-24">
        ...
        <div className="space-y-16">
          <div className="space-y-6">
            <h2 className="text-4xl md:text-5xl font-serif text-black tracking-tight font-medium leading-[0.9]">
      ...
      <div className="mt-48 pt-12 border-t border-black/10 flex flex-col md:flex-row justify-between items-center gap-8">
        <p className="text-sm font-mono text-black/30 uppercase tracking-widest">
          © 2026 Humberto Alonso López • Built with precision
        </p>
        <p className="text-sm font-serif text-black/50 italic leading-tight">
          WordPress Web Developer & Designer / Software Engineer
        </p>
      </div>
    </footer>
  );
